 ...
 * Original file: F:\\mycode\\music\\src\\com\\music\\service\\IMediaService.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.getPlayState();
reply.writeNoException();
...
@Override public void seekTo(int progress, java.lang.String playPath) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean getPlayState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public void seekTo(int progress, java.lang.String playPath) throws android.os.RemoteException;
public boolean getPlayState() throws android.os.RemoteException;
